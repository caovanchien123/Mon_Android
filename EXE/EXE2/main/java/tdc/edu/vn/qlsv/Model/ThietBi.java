...
public class ThietBi {
    ...
    public ThietBi(int id, String maTB, String tenTB, String xuatXuTB, String maLoaiTB, byte[] imgSignature) {
        this.id = id;
        this.maTB = maTB;
        this.tenTB = tenTB;
    ...
    public ThietBi(String maTB, String tenTB, String xuatXuTB, String maLoaiTB, byte[] imgSignature) {
        this.maTB = maTB;
        this.tenTB = tenTB;
        this.xuatXuTB = xuatXuTB;
        this.maLoaiTB = maLoaiTB;
